...
class Stegno:
    ...
    art ='''   \n  محمد سعيد محمد عطوه 20180500 \n    محمد محمود عبد الفتاح محمد  20180533 \n  محمد عبدالفتاح مغاوري مصطفي  20180516   \n   محمد عزالدين يونس 20180519  \n   محمد خالد شعيب 20180488    '''
    art2 = ''''''
    output_image_size = 0
    ...
    def main(self,root):
        ...
        title = Label(f,text=' Steganography')
        ...
        ascii_art.config(font=('courier',15))
